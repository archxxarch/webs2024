    ...
    <main id="main" role="main">
        <div class="intro__inner blogStyle bmStyle container">
            ...
            <div class="intro__text">
                <h3>글보기 페이지</h3>
                <p>개발에 필요한 지식을 한 눈에!<br> 웹개발과 관련된 최신 정보를 한 눈에 볼 수 있습니다.</p>
            </div>
        </div>
...
?>
    ...
    <div id="popupDelete" class="none">
        <div class="comment__delete">
            ...
            <input type="password" id="commentDeletePass" name="commentDeletePass" placeholder="비밀번호를 입력하세요.">
            <p>* 비밀번호를 입력해주세요.</p>
            <div class="btn">
                <button id="commentDeleteCancel">취소</button>
                <button id="commentDeleteButton">수정</button>
            </div>
        </div>
    </div>
    ...
    <div id="popupModify" class="none">
        <div class="comment__modify">
            ...
            <textarea name="commentModifyMsg" id="commentModifyMsg" cols="4" placeholder="수정할 내용을 적으세요."></textarea>
