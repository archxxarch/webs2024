...
<?php
    ...
    $sql = "SELECT b.boardId, b.boardTitle, m.youName, b.regTime, b.boardView, b.boardLike FROM Community b JOIN myMembers m ON(b.memberId = m.memberId) ORDER BY boardId DESC LIMIT {$viewLimit}, {$viewNum}";
    $result = $connect -> query($sql);
