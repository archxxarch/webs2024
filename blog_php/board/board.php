...
<?php
    ...
    $sql = "SELECT b.boardID, b.boardTitle, m.youName, b.regTime, b.boardView FROM board b JOIN blog_myMembers m ON(b.memberID = m.memberId) ORDER BY boardID DESC LIMIT {$viewLimit}, {$viewNum}";
    // $sql = "SELECT c.boardID, c.boardTitle, m.youName, c.regTime, c.boardView FROM Community c JOIN blog_myMembers m ON (c.memberID = m.memberId) ORDER BY c.boardID DESC LIMIT {$viewLimit}, {$viewNum}";
