    ...
    if($blogImgType){
        ...
        if($fileType === "image"){
            if($fileExtension === "jpg" || $fileExtension === "jpeg" || $fileExtension === "png" || $fileExtension === "gif" || $fileExtension === "webp"){
                ...
                $sql = "INSERT INTO blog(memberId, blogTitle, blogContents, blogRegTime, blogVIew, blogLike, blogImgFile, blogImgSize, blogDelete) VALUES('$memberId', '$blogTitle', '$blogContents', '$blogCategory', '$blogAuthor',  '$blogRegTime', '$blogView', '$blogLike', '$blogImgName', '$blogImgSize', '$blogDelete')";
        ...
        $sql = "INSERT INTO Bblog(memberId, blogTitle, blogContents, blogRegTime, blogVIew, blogLike, blogImgFile, blogImgSize, blogDelete) VALUES('$memberId', '$blogTitle', '$blogContents', '$blogCategory', '$blogAuthor',  '$blogRegTime', '$blogView', '$blogLike', 'Img_default.jpg', '$blogImgSize', '$blogDelete')";
